...
class Cliente {
  ...
  function publicarProductos() {
    producto.forEach((producto) => {
      ...
      contProducto.className = "producto";
      let nombre = document.createElement("h2");
      nombre.className = "nombre";
      marca.textContent = "${productos.nombre";
      let precio = document.createElement("h3");
      precio.className = "precio";
      precio.textContent = "${productos.precio";
  
      contProducto.appendChild(nombre);
  ...
  let cierreOrden =
    "El total de la orden es " +
    precioFinal +
    " IVA incluido. El precio con envío es " +
    precioConEnvio +
    ". Si pagas en " +
    cuotas +
    " cuota/s, tendrás un costo mensual de " +
    pagoCuotas;
